export const SITE_CONFIG = {
  ...
  description:
    "Broderie & personnalisation textile haut de gamme en Normandie. Uniformes pro et cadeaux personnalisés.",
  location: "Robertot (76560), Normandie",
  phone: "06 29 49 22 13",
  email: "bysandrinecouture@gmail.com",
  whatsapp: "33629492213",
  googleReview: "https://g.page/r/CUjGe3a2zEGtEBM/review",
  socials: {
  ...
  seo: {
    sectors: [
      ...
      {
        name: "Salons de coiffure & Esthétique",
        slug: "broderie-salon-coiffure-esthetique",
      },
  ...
  services: [
    {
      ...
      description:
        "Broderie haute définition sur cœur, manche ou dos pour vos uniformes.",
      icon: "Building2",
    ...
    },
    {
      ...
      title: "Univers Bébé",
      description:
        "Cadeaux de naissance personnalisés : gigoteuses, doudous, capes de bain.",
      icon: "Baby",
    ...
    },
    {
      ...
      description:
        "Serviettes, peignoirs et vêtements personnalisés pour particuliers.",
      icon: "Gift",
  ...
  packs: [
    {
      ...
      features: [
        "Séries courtes",
        "Frais de digitalisation offerts",
        "Rendu pro",
      ],
      price: "Sur devis",
    },
