    ...
    <div className="pt-32 animate-in fade-in duration-700">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-in slide-in-from-left-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              <Button 
                onClick={() => window.location.hash = 'devis?type=entreprise'}
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter italic uppercase mb-4">Pour quels types d’entreprises ?</h2>
            <p className="text-muted-foreground font-medium">Les demandes les plus fréquentes en broderie professionnelle.</p>
          </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
          <div>
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter italic uppercase mb-8">Articles brodés <br /><span className="text-primary not-italic">pour vos équipes</span></h2>
            ...
            <p className="p-4 bg-primary/5 rounded-xl border border-primary/20 text-[11px] font-bold uppercase tracking-widest text-primary italic">
              📌 Je peux broder sur vos textiles ou vous proposer une solution selon le projet.
            </p>
          </div>
          ...
          <div className="bg-black text-white p-10 md:p-16 rounded-[3rem] relative overflow-hidden">
            ...
            <p className="mt-12 text-[10px] font-black uppercase tracking-[0.2em] text-primary bg-primary/10 p-4 rounded-xl text-center italic">
              📌 Votre logo est optimisé avant broderie pour un rendu propre et lisible.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-pink-50/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter italic uppercase mb-4">Packs entreprise</h2>
            <p className="text-muted-foreground font-medium">Idéal pour démarrer rapidement avec une base claire.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {packs.map((pack, i) => (
              <div key={i} className={`p-10 rounded-[2.5rem] border flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 ${
                i === 1 ? 'bg-primary text-white border-primary shadow-2xl scale-105 z-10' : 'bg-white border-black/5'
              }`}>
                <div>
      ...
      <section className="py-24 px-6 bg-black text-white rounded-[4rem] mx-6 mb-24 overflow-hidden relative text-center">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter italic uppercase mb-8">Besoin d’un conseil ?</h2>
