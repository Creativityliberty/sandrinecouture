...
import {
  ...
  MapPin, CheckCircle2, Home, ShoppingBag, Lightbulb, Camera, Phone, Info
} from 'lucide-react';
    ...
    <div className="pt-32 animate-in fade-in duration-700">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center text-center lg:text-left">
          ...
          <div className="relative group hidden lg:block">
            ...
            <div className="relative h-[600px] rounded-[3rem] overflow-hidden shadow-2xl border-[10px] border-white">
              <img src="/images/realisations/serviette-brodee-chiens-orphee-nala.webp" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" alt="Broderie personnalisée animaux" />
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black tracking-tighter italic uppercase mb-4">Des idées qui marchent <br />à tous les coups</h2>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
          <div>
            <h2 className="text-3xl md:text-4xl font-black tracking-tighter italic uppercase mb-8">Personnalisation <br /><span className="text-primary not-italic">au choix</span></h2>
            ...
            <p className="p-4 bg-black text-white rounded-xl text-[10px] font-black uppercase tracking-widest text-center italic border-l-4 border-primary flex items-center justify-center gap-3">
              <Info size={14} className="text-primary" /> Avant production, on valide ensemble pour éviter toute erreur.
            </p>
          </div>
          ...
          <div className="bg-white p-10 md:p-16 rounded-[3rem] border border-black/5 shadow-xl relative overflow-hidden group">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground italic flex items-center gap-3">
              <Info size={12} className="text-primary" /> Vous pouvez apporter votre textile ou demander une solution selon le projet.
            </p>
      ...
      <section className="py-24 px-6 bg-pink-50/30">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black tracking-tighter italic uppercase mb-4">Comment commander ?</h2>
