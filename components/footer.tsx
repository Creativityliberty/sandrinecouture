  ...
  return (
    <footer className="bg-white border-t border-black/5 py-16 px-6 mt-12">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 text-left mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-xl md:text-lg font-black tracking-tighter italic uppercase leading-none">By Sandrine <br />Couture</h3>
            </div>
            <p className="text-gray-500 max-w-sm leading-relaxed mb-6 text-sm md:text-xs font-medium">
            ...
            <div className="space-y-2 text-sm md:text-xs font-bold uppercase tracking-widest text-primary/70">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm md:text-xs text-gray-400 font-medium list-none p-0">
              ...
              <li className="pt-2 border-t border-black/5 mt-3">
                <div className="flex flex-wrap gap-2">
                  {SITE_CONFIG.seo.cities.map(c => (
                    <Link key={c} href={`/#broderie-${c.toLowerCase()}`} className="text-[10px] md:text-[9px] hover:text-primary no-underline uppercase tracking-tighter">{c}</Link>
                  ))}
                </div>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-[9px] font-bold text-gray-400 uppercase tracking-widest">
